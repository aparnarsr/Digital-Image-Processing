...
for(int i=2;i<Size1+1;i+=2){
    for(int j=2;j<Size2+1;j++){
        ...
        Imagedatadif[i][j+1]=Imagedatadif[i][j+1]+(((e)*8)/48);
        Imagedatadif[i][j+2]=Imagedatadif[i][j+2]+(((e)*4)/48);
        Imagedatadif[i+1][j+2]=Imagedatadif[i+1][j+2]+(((e)*2)/48);
        Imagedatadif[i+1][j+1]=Imagedatadif[i+1][j+1]+(((e)*4)/48);
        Imagedatadif[i+1][j]=Imagedatadif[i+1][j]+(((e)*8)/48);
        Imagedatadif[i+1][j-1]=Imagedatadif[i+1][j-1]+(((e)*4)/48);
        Imagedatadif[i+1][j-2]=Imagedatadif[i+1][j-2]+(((e)*2)/48);
        Imagedatadif[i+2][j-2]=Imagedatadif[i+2][j-2]+(((e)*1)/48);
        Imagedatadif[i+2][j-1]=Imagedatadif[i+2][j-1]+(((e)*2)/48);
        Imagedatadif[i+2][j]=Imagedatadif[i+2][j]+(((e)*2)/48);
        Imagedatadif[i+2][j+1]=Imagedatadif[i+2][j+1]+(((e)*2)/48);
        Imagedatadif[i+2][j+2]=Imagedatadif[i+2][j+2]+(((e)*1)/48);
        ...
        Imagedatadif[p][q-1]=Imagedatadif[p][q-1]+(((e)*8)/48);
        Imagedatadif[p][q-2]=Imagedatadif[p][q-2]+(((e)*4)/48);
        Imagedatadif[p+1][q+2]=Imagedatadif[p+1][q+2]+(((e)*2)/48);
        Imagedatadif[p+1][q+1]=Imagedatadif[p+1][q+1]+(((e)*4)/48);
        Imagedatadif[p+1][q]=Imagedatadif[p+1][q]+(((e)*8)/48);
        Imagedatadif[p+1][q-1]=Imagedatadif[p+1][q-1]+(((e)*4)/48);
        Imagedatadif[p+1][q-2]=Imagedatadif[p+1][q-2]+(((e)*2)/48);
        Imagedatadif[p+2][q-2]=Imagedatadif[p+2][q-2]+(((e)*1)/48);
        Imagedatadif[p+2][q-1]=Imagedatadif[p+2][q-1]+(((e)*2)/48);
        Imagedatadif[p+2][q]=Imagedatadif[p+2][q]+(((e)*4)/48);
        Imagedatadif[p+2][q+1]=Imagedatadif[p+2][q+1]+(((e)*2)/48);
        Imagedatadif[p+2][q+2]=Imagedatadif[p+2][q+2]+(((e)*1)/48);
        }
